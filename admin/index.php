...
<html lang="en">
                                        ...
                                        <div class="modal fade" id="edit<?=$idb;?>">
                                         ...
                                         <div class="modal fade" id="delete<?=$idb;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="post">
                                                    <div class="modal-body">
                                                       Apakah Anda Yakin Menghapus Stock <?=$namabarang;?>?
                                                       <input type="hidden" name="idb" value="<?=$idb;?>">
                                                        <br>                   
                                                        <br>                             
    ...
    <div class="modal fade" id="myModal">
        ...
        <div class="modal-content">
            ...
            <form method="post">
                <div class="modal-body" >
                    <input type="text" name="namabarang" placeholder="Nama Stock" class="form-control" required>
                    <br>
                    <input type="text" name="deskripsi" placeholder="Deskripsi Stock" class="form-control" required>
                    <br>
                    <input type="number" name="stock" placeholder="Stock" class="form-control" required>
                    <br>
                    <input type="text" name="lokasi" placeholder="Lokasi Stock" class="form-control" required>
                    <br>
