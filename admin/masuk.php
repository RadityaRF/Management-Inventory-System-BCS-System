...
<html lang="en">
                                    ...
                                    <table class="table table-bordered" id="showtable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <h4 class="modal-title">Edit Stock Masuk</h4>
                                                ...
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                <h4 class="modal-title">Hapus Stock Masuk?</h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
                                                ...
                                                <form method="post">
                                                    <div class="modal-body">
                                                       Apakah Anda Yakin Menghapus Stock Masuk <?=$namabarang;?>?
                                                       <input type="hidden" name="idb" value="<?=$idb;?>">
    ...
    <div class="modal fade" id="myModal">
        ...
        <div class="modal-content">
            ...
            <!-- Modal Header -->
            <div class="modal-header">
            <h4 class="modal-title">Tambah Stock Masuk</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
